...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2020 at 02:57 PM
...
INSERT INTO `family` (`f_id`, `u_id`, `f_fname`, `f_lname`, `f_status`, `f_gender`, `f_teacher`) VALUES
(15, 23, 'child', 'one', 1, 'male', 16);
...
INSERT INTO `groups` (`gId`, `gName`, `gSubname`, `idTeacher`, `idStudent`, `gType`, `status`, `empty`) VALUES
(4, 'student sayed `s Group', 'Sayed Teacher', 16, 17, 0, 1, 0),
(5, 'Sayed Khaled `s Group', 'Sayed Teacher', 16, 21, 0, 1, 0),
(7, 'Sayed Khaled `s Group', 'teacher', 16, 5, 19, 1, 0),
(8, 'Sayed Khaled `s Group', 'teacher', 16, 6, 19, 1, 0),
(9, 'Sayed Khaled `s Group', 'teacher', 16, 7, 19, 1, 0),
(10, 'Sayed Khaled `s Group', 'teacher', 16, 8, 19, 0, 0),
(11, 'Sayed Khaled `s Group', 'teacher', 16, 9, 19, 1, 0),
(12, 'Sayed Khaled `s Group', 'teacher', 16, 10, 19, 1, 0),
(13, 'Sayed Khaled `s Group', 'teacher', 16, 11, 19, 1, 0),
(14, 'Sayed Khaled `s Group', 'teacher', 16, 12, 19, 1, 0),
(15, 'Sayed Khaled `s Group', 'teacher', 16, 13, 18, 1, 0),
(17, 'child one `s Group', 'teacher', 16, 15, 23, 1, 0);
...
(80, 'this message deleted', 4, '2020-08-06 16:40:14', 17, 'student sayed', 4, 1, 1, 0),
(81, 'this message deleted', 4, '2020-08-06 16:40:26', 17, 'student sayed', 4, 1, 1, 0),
(82, '🙄', 4, '2020-08-06 16:40:49', 17, 'student sayed', 1, 1, 1, 0),
(83, 'this message deleted', 4, '2020-08-06 16:54:08', 16, 'Sayed Teacher', 4, 0, 1, 0),
(84, 'dds', 4, '2020-08-06 19:09:07', 16, 'Sayed Teacher', 1, 0, 1, 0);
...
(8, 17, 'fsdfdsf', '2020-08-18 16:52:00', 'support');
...
(21, 'Sayed', 'Khaled', 'Male', 'stu', '01153198183', 'dsfdafsd', 'sdfsdf', 16, 'Avatarmale.png', '0', 1, 'saydassed.khaled7123@gmail.com', 'cXFx', 0),
(22, 'Sayed', 'Khaled', 'Male', 'Te', '01153198183', 'asfdaf', 'sdv', 0, 'Avatarmale.png', '0', 1, 'sayed.khasdasdaled7123@gmail.com', 'cXE=', 0),
(23, 'Sayed', 'Khaled', 'male', 'par', '01153198183', 'sdfda', 'dsfsd', 0, 'Avatarmale.png', '0', 1, 'sayed.khssaled7123@gmail.com', 'MQ==', 0);
...
--
ALTER TABLE `problem`
  ADD CONSTRAINT `fkId` FOREIGN KEY (`u_id`) REFERENCES `users` (`uId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
